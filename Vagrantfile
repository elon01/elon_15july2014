...
Vagrant.configure("2") do |config|
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/elon_15july2014"
  #   chef.validation_client_name = "elon_15july2014-validator"
  #   chef.validation_key_path = ".chef/elon_15july2014-validator.pem"
  # end
end
